...
function proposal(id, status = "pending") {
  return {
    ...
    professor_id: 7,
    status,
    old_values: { name: "Alice Systems", title: "Professor", email: "alice@illinois.edu", homepage_url: null, lab_url: "https://old.example.edu", research_summary: "Old summary", tags: ["Systems"], source_urls: ["https://ece.illinois.edu/alice"] },
    new_values: { name: "Alice Systems", title: "Professor", email: "alice@illinois.edu", homepage_url: "https://alice.example.edu", lab_url: "https://new.example.edu", research_summary: "New summary", tags: ["Reliable AI"], source_urls: ["https://ece.illinois.edu/alice", "https://new.example.edu"] },
